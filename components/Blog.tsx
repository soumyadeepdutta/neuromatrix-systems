...
import { Tag, User, Calendar, ArrowRight } from 'lucide-react'
            ...
            <button
              ...
              className={`px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
                selectedCategory === category
                  ...
                  : 'bg-[#1C1C1C] text-nm-text/80 hover:bg-[#2a2a2a] hover:text-nm-text border border-nm-primary/20'
              }`}
            >
              {category}
            </button>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredPosts.map((post, index) => (
            <motion.article
              ...
              whileHover={{ y: -10 }}
              className="bg-[#1C1C1C] backdrop-blur-sm rounded-2xl overflow-hidden border border-nm-primary/20 hover:border-nm-accent/60 hover:shadow-[0_0_20px_rgba(255,87,34,0.3)] transition-all duration-300 h-full"
            >
              {/* Post Image */}
