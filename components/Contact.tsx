...
import { Phone, Mail, MapPin, Linkedin, Twitter, Github, CheckCircle, ArrowRight } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {isSubmitted && (
                <motion.div
                  ...
                  className="bg-nm-secondary/20 border border-nm-secondary/40 rounded-2xl p-6 text-center mb-6"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#1C1C1C] border border-nm-primary/30 rounded-lg text-nm-text placeholder-nm-text/50 focus:outline-none focus:border-nm-primary focus:ring-2 focus:ring-nm-primary/20 transition-all duration-200"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-[#1C1C1C] border border-nm-primary/30 rounded-lg text-nm-text placeholder-nm-text/50 focus:outline-none focus:border-nm-primary focus:ring-2 focus:ring-nm-primary/20 transition-all duration-200 resize-none"
          ...
          >
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 bg-[#1C1C1C] rounded-xl flex items-center justify-center text-nm-text hover:bg-nm-primary hover:text-white transition-all duration-200"
                  >
            ...
            <div>
              ...
              <div className="bg-[#1C1C1C] rounded-2xl p-4 border border-nm-primary/20 hover:border-nm-accent/60 hover:shadow-[0_0_20px_rgba(255,87,34,0.3)] transition-all duration-300">
