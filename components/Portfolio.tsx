        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {caseStudies.map((project, index) => (
            ...
            >
              <motion.div
                whileHover={{ y: -10 }}
                className="bg-nm-accent/10 backdrop-blur-sm rounded-2xl overflow-hidden border border-nm-accent/30 hover:border-nm-accent/60 hover:shadow-[0_0_20px_#9D00FF] transition-all duration-300 h-full relative"
              >
                {/* Project Image */}
                    ...
                    <div className="p-6 w-full">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.technologies.slice(0, 3).map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="px-2 py-1 bg-nm-accent/20 text-nm-text/80 text-xs rounded"
                          >
                            {tech}
                          </span>
                        ))}
                        {project.technologies.length > 3 && (
                          <span className="px-2 py-1 bg-nm-accent/20 text-nm-primary text-xs rounded">
                            +{project.technologies.length - 3}
                          </span>
                        )}
                      </div>
