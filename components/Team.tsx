...
export default function Team() {
  ...
  return (
    <section id="team" className="py-20 bg-nm-bg relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-bl from-nm-secondary via-transparent to-nm-accent" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-nm-text mb-6">
            Meet Our <span className="text-nm-primary">Team</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              >
                {/* Background Gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-nm-primary/5 to-nm-secondary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                
                {/* Profile Image */}
                <div className="relative z-10 mb-6">
                  <div className="w-24 h-24 mx-auto mb-4 bg-gradient-nm rounded-full p-1 group-hover:scale-110 transition-transform duration-300">
                    <div className="w-full h-full bg-nm-accent/20 rounded-full flex items-center justify-center">
                      <div className="text-center text-nm-primary">
                        <div className="w-16 h-16 bg-nm-primary/20 rounded-full flex items-center justify-center mx-auto mb-2">
                ...
                <div className="relative z-10 text-center">
                  <h3 className="text-xl font-bold text-nm-text mb-2 group-hover:text-nm-primary transition-colors duration-300">
                    {member.name}
                  </h3>
                  <p className="text-nm-primary font-medium mb-4">
                    {member.position}
                  </p>
                  
                  <p className="text-nm-text/80 text-sm leading-relaxed mb-6 line-clamp-4">
                    {member.bio}
                  </p>
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-t from-nm-bg/80 via-transparent to-transparent rounded-2xl flex items-end justify-center pb-6"
                >
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-nm text-white px-6 py-2 rounded-lg font-medium text-sm hover:shadow-lg hover:shadow-nm-primary/25 transition-all duration-200 flex items-center gap-2 group/btn"
                  >
                    View Profile
