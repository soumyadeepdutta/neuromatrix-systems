...
export default function Footer() {
  ...
  return (
    <footer className="bg-nm-bg border-t border-nm-accent/20 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex gap-3">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-10 h-10 bg-nm-accent/20 rounded-lg flex items-center justify-center text-nm-primary hover:bg-nm-secondary hover:text-white transition-all duration-200"
                  >
              ...
              <ul className="space-y-3">
                {quickLinks.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-nm-text/80 hover:text-nm-secondary transition-colors duration-200 text-sm"
                    >
                      {link.name}
                    </a>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {services.map((service) => (
                  <li key={service}>
                    <span className="text-nm-text/80 text-sm cursor-pointer hover:text-nm-secondary transition-colors duration-200">
                      {service}
                    </span>
                  </li>
                ))}
              ...
              <div className="space-y-3">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    whileHover={{ x: 5 }}
                    className="flex items-center gap-2 text-nm-text/80 hover:text-nm-secondary transition-colors duration-200 text-sm"
                  >
        ...
        <div className="py-8 border-t border-nm-accent/20">
        ...
        {/* Bottom Footer */}
        <div className="py-6 border-t border-nm-accent/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-nm-text/60">
              <a href="#" className="hover:text-nm-secondary transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-nm-secondary transition-colors duration-200">
                Terms of Service
